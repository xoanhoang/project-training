...
export class updatePostTable1667550984219 implements MigrationInterface {
    name = 'updatePostTable1667550984219'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "cart" ("id" SERIAL NOT NULL, "quantity" integer, "productsId" integer, "userId" uuid, CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('0', '1', '2', '3', '4')`);
        ...
        await queryRunner.query(`CREATE TABLE "orderDetail" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "total" integer, "orderId" integer, "productId" integer, CONSTRAINT "PK_39c7d4260520bd85b6fd76f6443" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "price" integer NOT NULL, "sku_id" character varying, "picture" character varying NOT NULL, "inventory" integer NOT NULL, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "attribute_value" ("id" SERIAL NOT NULL, "value" character varying NOT NULL, "productId" integer, "attributeId" integer, CONSTRAINT "PK_dff76d9cc1db2684732acdb9ca7" PRIMARY KEY ("id"))`);
