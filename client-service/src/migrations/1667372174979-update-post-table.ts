...
export class updatePostTable1667372174979 implements MigrationInterface {
    name = 'updatePostTable1667372174979'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "price" integer NOT NULL, "sku" character varying, "picture" character varying NOT NULL, "inventory" integer NOT NULL, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
